...
var SimpleShape = function (_L$Handler) {
  ...
  (0, _createClass3.default)(SimpleShape, [{
    ...
    value: function _createMoveMarker() {} // Children override
    ...
    value: function _createResizeMarker() {// Children override
    }
  }, {
    key: '_createMarker',
    ...
    value: function _onMarkerDrag(event) {
      ...
      if (marker === this._moveMarker) // $FlowFixMe overridden in children
        this._move(latlng);else // $FlowFixMe overridden in children
        this._resize(latlng);
    ...
    key: '_move',
    value: function _move() {} // Children override
    ...
    key: '_resize',
    value: function _resize() {// Children override
    }
  }]);
  return SimpleShape;
